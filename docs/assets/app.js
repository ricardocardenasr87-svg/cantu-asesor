      ...
      <div class="container">
        <div class="topbar">
          ...
          <nav class="nav" id="primary-nav" aria-label="Secciones">
            ...
            <a href="#faq">FAQ</a>
            <a class="cta" href="#contacto">${CONFIG.bookingLabel}</a>
          </nav>
        </div>
      </div>
      ...
      <div class="container footer-grid">
        ...
        <div>
          ...
          <ul class="footer-list">
            ...
            <li><a href="#contacto">${CONFIG.bookingLabel}</a></li>
          </ul>
        </div>
...
function initTicker(){
  ...
  host.innerHTML = `
    <div class="ticker-fallback" role="status" aria-live="polite">
      <span>S&P 500 · 4,783.45</span>
      <span>Nasdaq 100 · 15,310.97</span>
      <span>IPC México · 55,432.10</span>
      <span>USD/MXN · 17.05</span>
      <span>UDI · 8.10</span>
    </div>
    <div class="tradingview-widget-container" aria-hidden="true">
  ...
  const fallback = host.querySelector('.ticker-fallback');
...
function initPageEnhancements(){
  ...
  $all('[data-advisor-name]').forEach(el => {
    el.textContent = CONFIG.advisorName;
  });
